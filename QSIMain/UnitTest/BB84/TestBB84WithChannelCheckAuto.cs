...
namespace UnitTest
{
    ...
    class TestBB84WithChannelCheckAuto
    {     
        ...
        static void QuantumChannelProcess(DensityOperator[] densityopEncArray)
        {
           foreach (var densityopMember in densityopEncArray)
            {
                //SuperMatrixTrans(densityopMember, superBitFlip0_5);   //This needs a densityoperator, we only provide ket.In channel, only accept densityoperator
                //SuperMatrixTrans(densityopMember, superI);  //I
                //SuperMatrixTrans(densityopMember, superBitFlip0_25);    //Bit flip,p=0.25
                //SuperMatrixTrans(densityopMember, superBitFlip0_75);     //Bit filip,p=0.75
                //SuperMatrixTrans(densityopMember, superDepolariz);     //Bit filip,p=0.75     
                SuperMatrixTrans(densityopMember, SuperAmplDamp);
            }
        }
